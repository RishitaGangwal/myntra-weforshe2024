...
const CountdownTimer = () => {
  ...
  return (
    <div className="px-2 py-3 sm:px-5 sm:py-[.75rem] flex items-center justify-evenly gap-2 sm:gap-5 overflow-hidden relative rounded-lg sm:rounded-[8px] border border-solid border-[rgba(255,255,255,.1)] bg-[rgba(0,0,0,.2)] shadow-inner mt-3">
